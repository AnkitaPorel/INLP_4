...
if __name__ == "__main__":
    ...
    train_csv = "/kaggle/input/my-dataset/train.csv"  # Adjust as needed
    test_csv = "/kaggle/input/my-dataset/test.csv"    # Provide test.csv or split train.csv
    ...
    # Train and evaluate for each mode
